...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "cfssl" ]; then
    ...
    peer_cert peer peer0.org1.educredph.com org1
    peer_cert admin Admin@org1.educredph.com org1

    infoln "Creating Org2 Identities"
    #function_name cert-type   CN   org
    peer_cert peer peer0.org2.educredph.com org2
    peer_cert admin Admin@org2.educredph.com org2

    infoln "Creating Orderer Org Identities"
    #function_name cert-type   CN   
    orderer_cert orderer orderer.educredph.com
    orderer_cert admin Admin@educredph.com
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm docker_orderer.educredph.com docker_peer0.org1.educredph.com docker_peer0.org2.educredph.com
